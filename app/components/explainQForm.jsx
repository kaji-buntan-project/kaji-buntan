    ...
    return (
        <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', justifyContent: 'start', marginBottom: '1.5em'}}>
            ...
            <Box sx={{
                ...
                <b className='text'><font size="2" color="#9c27b0"><a href="https://drive.google.com/file/d/1VF6hrktuFPq-ggrXRL_iqQeUCKxWCzVk/view?usp=sharing" target="blank">{ "→詳しい説明へ\n" }</a></font></b>
                <b className='text'><font size="3">{ "アンケートにご協力ください\n" }</font></b>
                <b className='text'><font size="2" color="#9c27b0"><a href="https://forms.gle/kjHo2mRW1PpJEBE59" target="blank">{ "→アンケートへ\n" }</a></font></b>
                <Box sx={{
