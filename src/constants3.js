const allTasks = [
    {
        ...
        children: [
            ...
            {name: 'Dust furnitures', checked: false},
            {name: 'Clean windows', checked: false},
            {name: 'Water indoor plants', checked: false},
        ],
    }, {
        name: "Kitchen",
        children: [
            ...
            {name: 'Clear out fridge or wipe shelves', checked: false},
            {name: 'Wash dishes', checked: false},
            {name: 'Dry dishes', checked: false},
            {name: 'Load dishwasher', checked: false},
            {name: 'Unload dishwasher', checked: false},
        ],
    }, {
        name: "Bathroom",
        children: [
            ...
            {name: 'Clean floor', checked: false},
        ...
        children: [
            ...
            {name: 'Clear garbage', checked: false},
        ...
        children: [
            ...
            {name: 'Water outdoor plants', checked: false},
        ...
        children: [
            ...
            {name: 'Serve breakfast for kids', checked: false},
            {name: 'Pick-up from schools', checked: false},
        ],
    },{
        name: "Baby",
        children: [
            {name: 'Diaper change', checked: false},
            {name: 'Feed baby', checked: false},
            {name: 'Dress baby', checked: false},
            {name: 'Bathe baby', checked: false},
            {name: 'Brush teeth & wash face', checked: false},
        ],
    },
];
...
const backgroundColorList = {
    ...
    'Kids' : 'rgba(2, 203, 2, 0.2)',
    'Baby' : 'rgba(0, 0, 207, 0.2)',
