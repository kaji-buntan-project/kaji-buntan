...
const allTasks = [
    {
        name: "朝の準備",
        children: [
            { name: "子供を起こす", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "朝ごはん用意", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "新聞とる", checked: false, myDefault: 3, partnerDefault: 4 }
        ],
    }, {
        name: "料理",
        children: [
            { name: "献立決めて買い物", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "冷蔵庫に入れる", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "料理する", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "盛り付け", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "テーブル拭く", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "配膳", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "食器片付ける", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "食器用洗剤の購入", checked: false, myDefault: 4, partnerDefault: 3 },
        ...
        name: "洗濯",
        children: [
            { name: "フィルターのホコリを取る", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "洗濯洗剤の購入", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "漂白剤、柔軟剤の購入", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "洗濯機の掃除", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "洗濯物を干す", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "洗濯物を取り込む", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "洗濯物を畳む", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    }, {
        name: "お風呂の準備",
        children: [
        ...
        name: "掃除 (お風呂場)",
        children: [
            { name: "浴槽を洗う", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "壁ドア・鏡・手すりを洗う", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "床を洗う", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "髪の毛取ってネット交換", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "排水溝を洗う", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    }, {
        name: "掃除 (トイレ)",
        children: [
            ...
            { name: "トイレットペーパーの購入", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "トイレ洗剤の購入・補充", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    }, {
        name: "掃除 (キッチン)",
        children: [
            { name: "食器洗う", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "食器を拭く", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "シンクの水気を拭く", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "食器をしまう", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "調味料の量把握・補充", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "キッチン台の片付け", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "調理器具をしまう", checked: false, myDefault: 11, partnerDefault: 10 },
            { name: "ガス台・ごとくの拭き掃除", checked: false, myDefault: 10, partnerDefault: 11 },
            { name: "食洗器の掃除", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "炊飯器の掃除", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "レンジ・オーブンの掃除", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "トースターの掃除", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "キッチン壁・床の拭き掃除", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "換気扇の掃除", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    }, {
        name: "掃除 (家全体)",
        children: [
            { name: "家中を掃除機かける", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "出しっ放しのものをしまう", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "玄関の掃除", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "靴を整頓", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "傘をしまう", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "テレビ、テレビ台の掃除", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "床の掃除・モップかける", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "物の整理整頓", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "子供部屋の掃除", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    },{
        name: "ゴミ捨て",
        children: [
            { name: "ゴミ集める・分ける", checked: false, myDefault: 4, partnerDefault: 3 },
            ...
            { name: "ダンボールをつぶして捨てる", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    },{
        name: "家庭内の雑用",
        children: [
            { name: "家族のスケジュール管理", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "郵便物を取りに行く", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "郵便物の仕分け・管理", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "米・ビールの補充", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "日用品の買い足し・補充", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "アイロン", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "植物に水やり", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "加湿器に水入れる", checked: false, myDefault: 3, partnerDefault: 4 },
        ],
    },{
        name: "子供・学校",
        children: [
            { name: "交友の把握・管理", checked: false, myDefault: 2, partnerDefault: 3 },
            { name: "勉強みる", checked: false, myDefault: 3, partnerDefault: 2 },
            { name: "行事ごとの持ち物把握", checked: false, myDefault: 2, partnerDefault: 3 },
            { name: "スマホ・ゲーム時間の管理", checked: false, myDefault: 3, partnerDefault: 2 },
            { name: "習い事の送迎", checked: false, myDefault: 2, partnerDefault: 3 },
            { name: "水筒を洗う", checked: false, myDefault: 3, partnerDefault: 2 },
            { name: "体操服を洗う", checked: false, myDefault: 2, partnerDefault: 3 },
            { name: "テストやプリントの管理", checked: false, myDefault: 3, partnerDefault: 2 },
            { name: "学校行事に参加", checked: false, myDefault: 1, partnerDefault: 0 },
            { name: "学校のPTA活動に参加", checked: false, myDefault: 0, partnerDefault: 1 },
            { name: "地域集会に参加", checked: false, myDefault: 1, partnerDefault: 0 },
            { name: "保護者会に参加", checked: false, myDefault: 0, partnerDefault: 1 },
            { name: "写真の整理整頓", checked: false, myDefault: 2, partnerDefault: 3 },
        ],
    },{
        name: "ペット関連",
        children: [
            { name: "朝の散歩", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "夕方の散歩", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "餌をやる", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "餌の購入", checked: false, myDefault: 4, partnerDefault: 3 },
            { name: "遊ぶ", checked: false, myDefault: 3, partnerDefault: 4 },
            { name: "毛並みを整える", checked: false, myDefault: 4, partnerDefault: 3 },
        ],
    },{
        name: "介護",
        children: [
