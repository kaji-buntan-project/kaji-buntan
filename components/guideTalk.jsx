...
export default function GuideTalk(props) {
    ...
    function getSaying() {
        if (props.tabnumber == 0){
            ...
            if(isMobile){
                return "For each chore, enter\n(1) whether your partner are currently responsible,\n(2) whether your partner are positive/neutral/negative,\n(3) how long it takes time for your partner to complete";
                //return "パートナーの\n ・好き嫌い\n ・一回あたりにかかる時間\n を教えてね";
            }else{
                return "For each chore, enter\n(1) whether your partner are currently responsible,\n(2) whether your partner are positive/neutral/negative,\n(3) how long it takes time for your partner to complete";
